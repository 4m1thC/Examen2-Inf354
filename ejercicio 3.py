...
nodos = {x: y for x, y in zip(names_list, coordinates_list)}
...
def compute_city_distance_names(city_a, city_b, nodos):
    return compute_city_distance_coordinates(nodos[city_a], nodos[city_b])
